    ...
    <section className="py-16 relative overflow-hidden">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16 relative">
          ...
          <p className="text-[21px] font-normal leading-[28px] text-[#1A1A1A] text-center">
        ...
        <div className="flex justify-center items-center gap-[60px] w-[1152px] h-[250px] flex-shrink-0 mx-auto mb-12">
          <div className="flex flex-col items-center gap-2 h-[166px] px-10 py-[30px] rounded-xl border-t border-[#DCF6D6] bg-white shadow-[1px_7.11px_6px_0px_rgba(78,203,113,0.16)]">
            <h3 className="text-[24px] font-semibold leading-[26px] text-[#38393E] capitalize whitespace-nowrap mb-4">
              Safe Learning Environment
            </h3>
            <p className="text-[17px] font-normal leading-[24px] text-[#38393E] text-center">
        ...
        <div className="text-center">
          <button className="inline-flex justify-center items-center gap-2 py-[18px] px-10 bg-[#5FBE7A] hover:bg-green-600 text-white font-semibold rounded-[50px] transition-colors">
            Try for free
          </button>
        </div>
      </div>
